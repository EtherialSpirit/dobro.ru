...
Easy like box display facebook like box. it enable Facebook Page owners to attract and gain Likes from their own website. 

== Description ==

Easy like box display facebook like box. it enable Facebook Page owners to attract and gain Likes from their own website. The Like Box enables users to see page likes, recent posts from the page and Like button and which of friends like this page too.
...
Now Shortcode is available in Easy Like Box and User can easily create shortcode by using widget.
...
1. Upload the entire Easy Like Box folder to your wp-content/plugins/ directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.

= Option 2 =

1. Download Easy Like Box.
2. Goto wordpress dashboard > plugin > add new and click on upload.
3. Browse Easy Like Box and click on upload button.
4. Then click on Activate plugin.

== Screenshots ==

1. FB Like box in dark color scheme.
2. FB Like box in light color scheme.
